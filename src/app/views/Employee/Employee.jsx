...
//   import EmployeeDialog from './EmployeeDialog'
  ...
  class Employee extends React.Component {
    ...
    hienThiProps = () =>{
      console.log("aaaa",this.state.employeeName)
    }
                  ...
                  <MaterialButton
                    ...
                    onSelect={ async (rowData, method) => {
                      if (method === 0) {
                        ...
                        await this.setState({ employeeName: rowData,

                         }, () => {
                            console.log("da setState", this.state.employeeName)
                          });
                        this.handleOpenDialog();
                        this.hienThiProps();
                         
                        // editEmployee(rowData).then(({ data }) => {
                        //   if (data.parent === null) {
                        //     data.parent = {}
                        //   }
          ...
          <div className="m-sm-30">
            ...
            <Grid container spacing={2} justify="space-between">
              <Grid item lg={3} md={3} xs={12} >
                ...
                <EmployeeDialog open={this.state.isDialogOpen} onClose={this.handleCloseDialog} onSave={this.handleSaveEmployee} Data = {this.state.employeeName}  />
